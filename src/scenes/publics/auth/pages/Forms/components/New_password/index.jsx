         ...
         {({ handleChange, values }) => (
            <div className={styles.container}>
               <form onSubmit={handleSubmit(onSubmit)} className={styles.form}  >
                  <h1 className={styles.form_title}>Definir nova senha</h1>
                  ...
                  <label className={styles.rename_label} htmlFor="password">Nova senha<span className={styles.required_symbol} ></span></label>
                  ...
                  /> */}
                     ...
                     />
                     <img src={showPassword ? Eye : Nosee} alt='olho' className={styles.img} onClick={togglePasswordVisibility} />
                  </div>

                           <div className={styles.mensage_error}><ErrorMessage name="password" component="div" /></div>

                  <label className={styles.rename_label} htmlFor="confirmPassword">Confirme nova senha<span className={styles.required_symbol} ></span></label>
                  <div className={styles.content}>
                     {/* <input
                        type={showPassword ? 'text' : 'password'}
                     /> */}
                  ...
                  <div className={styles.conteiner}>
                     ...
                     <div>
                        ...
                        <Link className={styles.new_password} to="/">
                         Concluir
                        </Link>
                        </button>
                     </div>
